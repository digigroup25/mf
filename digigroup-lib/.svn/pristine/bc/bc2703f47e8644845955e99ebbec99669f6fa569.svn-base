package mindmaps2.actions.task {
	...
	public class PrioritizeByRatingAction extends AbstractUserAction {
		public function PrioritizeByRatingAction(name:String = "Prioritize by rating", repeatCount:int = 1) {
		...
		override protected function doExecute():void {
			...
			var m:Message = new Message(TaskMessages.PRIORITIZE, this, { node: node, fieldName: "priority" });
			container.send(m);
