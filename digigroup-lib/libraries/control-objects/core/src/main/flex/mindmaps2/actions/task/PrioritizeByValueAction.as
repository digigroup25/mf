package mindmaps2.actions.task {
	...
	public class PrioritizeByValueAction extends AbstractUserAction {
		public function PrioritizeByValueAction(name:String = "Prioritize by value", repeatCount:int = 1) {
		...
		override protected function doExecute():void {
			...
			var m:Message = new Message(TaskMessages.PRIORITIZE, this, { node: node, fieldName: "value" });
			container.send(m);
