...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserMap.last_modified'
        db.add_column('maps_usermap', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserMap.last_modified'
        db.delete_column('maps_usermap', 'last_modified')
